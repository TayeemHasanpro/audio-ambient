...
const ALL_SOUNDS_CONFIG = {
  Nature: [
    { id: 'rain', name: 'Rain', category: 'Nature', icon: 'water_drop', file: 'rain.wav', image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuB1Fktw8woiWqx41ZqOl5JY8m6SnBBZ-EFTb_Us_7s2qNFl-GC3XmNZ0rWsUW-seOsNDvW-0e11x6GN15kAEHdeOVzvxL7uluvoG7MWo76rfuNyZsccgSwPxFbb0S2ZysnJ2B4Oa1c0NEDSaO_WPH-LM9Mt_9xqFlBc_6zEvC53OHxQXUzpk09edIaeTwV40Q9CqBgmVGEa8_DvvqBcro9KAr4Br78E32whYR4F6DbqFXEZn1kRYDg5DPicqas-hOYA1-jCGSlkT38' },
    { id: 'ocean', name: 'Ocean Waves', category: 'Nature', icon: 'waves', file: 'ocean.wav', image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAlWuwOzX7_T6uxwjvdiSHwZIigQ7BFz-ON2iYuICDpT2p1ugVdS2IKizENE_b1ZOXoKVMgH5b0BC7UmpeCWbjpDZDypIkiubFthzeg224E-kflYV8fYOvLpJbzAGvzidxvQfhjUxvssk0CSp1iD-Hgu0p-kRLMyLqwNTZ0xl5iN15WUg7z0DNxAIITeKQgsg_y2hHuxCIMeNhFzCGeCBOvElG2UJC77nBOWP2bK1B4MWvNVBUZ81nDaZWruGpqHcJUpIzb4Ku9u8c' },
    { id: 'forest', name: 'Forest Birds', category: 'Nature', icon: 'forest', file: 'Forest Birds.wav', image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAmqdJL30I4z3hB2Cbh4xo2t-oUIEsI2-ANN0kwkkDQU0-cf3-YJFbAVQX91oiJEApRSMYFr8swNXSp7QawMT5_dbEIPXfq_xNLrwhSRynDpe7lLo6Mh9_esLlmP5wkVZ7dkHjDVbODbTdZ2NsYpOfBV1yxjB3Ga0CYlKxPpQIbQrY4RFgthTaT7xK3BGorcqdZ59yQjv8uKV9CQLTOBDZ7-6ICpBpgdeDBH667jDgT5Rj760MKGgYOB635RIBO-EGuohOtyIN08DQ' },
    { id: 'wind', name: 'Wind', category: 'Nature', icon: 'air', file: 'Strong Gusty Wind.wav', image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDn6_KCyvGgCLSifncjVSfs2fK1C4I3lvoZmx0VWFfCAb7bYMdWWJvXp9eV9Xg0Ae9zvYrIawPrWDHRpsx9UpoQI8_o0naheKZxfuG-dx-34O9rC2NTIKyxmoROPFTX2O3BVCSwbp-dE6KpLU5uiBfVF1MA6-IvnatCDSMvAhdgjz_vm2gWrv4Q5S5IMeFsD4Xvoc5UosXNRty6ThSe8FHWCK77KHEsmNK_wiqoXrfE-W50tHN-TNwZSPd8br60P3FMTU_t2e1EUUk' },
    { id: 'fireplace', name: 'Campfire', category: 'Nature', icon: 'local_fire_department', file: 'Campfire.wav', image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDT4IMwy8G6Uzw5NNKAgRSkaw2XWw34ifeoa2c6rnHH8dBKYeeZjNOcvTlZSk5WyBBL3Ogqmikb9oU8p7MYqCnKK_XJREc3dud9PouGrnff5IDsLIjyOXaCRk1yKRqvSMU2t-on8XDzbm84FbrDQ_o4oFFyBd8UWdEx3GmeBur_TNQezrejK4EWygiVN474KCtqyvPJDh3LGto4qmicat2Ry0VvHDIOFM1A1vhgfefw0_G_hADrxIDAlorlqg1vx6N5cS682ZJ5HSQ' },
    { id: 'afternoon_open_field', name: 'Afternoon Open Field', category: 'Nature', icon: 'eco', file: 'Afternoon Open field.wav' },
    { id: 'crickets_insects', name: 'Crickets & Insects', category: 'Nature', icon: 'bug_report', file: 'Crickets and Insects.wav' },
    { id: 'crickets', name: 'Crickets', category: 'Nature', icon: 'bug_report', file: 'Crickets.wav' },
    { id: 'dawn_skyline', name: 'Dawn Skyline', category: 'Nature', icon: 'wb_sunny', file: 'Dawn skyline.wav' },
    { id: 'grasshopper_summer', name: 'Summer Grasshopper', category: 'Nature', icon: 'bug_report', file: 'Grasshopper - Summer.wav' },
    { id: 'insect', name: 'Insect', category: 'Nature', icon: 'bug_report', file: 'Insect.wav' },
    { id: 'nature', name: 'Nature', category: 'Nature', icon: 'landscape', file: 'Nature.wav' },
    { id: 'rising_summer_rain', name: 'Rising Summer Rain', category: 'Nature', icon: 'rainy', file: 'Rising summer rain.wav' },
    { id: 'summer_birds_singing', name: 'Summer Birds', category: 'Nature', icon: 'flutter_dash', file: 'Summer Birds Singing.wav' },
    { id: 'summer_cicadas', name: 'Summer Cicadas', category: 'Nature', icon: 'bug_report', file: 'Summer Cicadas.wav' },
    { id: 'summer_forest', name: 'Summer Forest', category: 'Nature', icon: 'forest', file: 'Summer Forest.wav' },
    { id: 'summer_morning', name: 'Summer Morning', category: 'Nature', icon: 'wb_twilight', file: 'Summer Morning.wav' },
    { id: 'summer_night', name: 'Summer Night', category: 'Nature', icon: 'nights_stay', file: 'Summer Night.wav' },
    { id: 'wind_01', name: 'Wind 01', category: 'Nature', icon: 'air', file: 'Wind 01.wav' },
    { id: 'wind_02', name: 'Wind 02', category: 'Nature', icon: 'air', file: 'Wind 02.wav' },
    { id: 'wind_03', name: 'Wind 03', category: 'Nature', icon: 'air', file: 'Wind 03.wav' },
    { id: 'windy_residential', name: 'Windy Residential', category: 'Nature', icon: 'air', file: 'Windy Residential.wav' },
  ],
  Ambient: [
    { id: 'brown', name: 'Brown Noise', category: 'Ambient', icon: 'noise_aware', file: 'brown.wav' },
    { id: 'white', name: 'White Noise', category: 'Ambient', icon: 'radio', file: 'white.wav' },
    { id: 'binaural', name: 'Binaural', category: 'Ambient', icon: 'headphones', file: 'binaural.wav' },
    { id: 'cafe', name: 'Cafe', category: 'Ambient', icon: 'local_cafe', file: 'cafe.wav' },
  ],
  Mechanical: [
    { id: 'city', name: 'City', category: 'Mechanical', icon: 'location_city', file: 'city.wav' },
    { id: 'control_tower', name: 'Control Tower', category: 'Mechanical', icon: 'cell_tower', file: 'Control Tower.wav' },
    { id: 'diesel_train_passing', name: 'Diesel Train Passing', category: 'Mechanical', icon: 'train', file: 'Diesel Train Passing.wav' },
    { id: 'heathrow_air_traffic', name: 'Air Traffic', category: 'Mechanical', icon: 'flight', file: 'Heathrow Air Traffic.wav' },
    { id: 'trains_diesel_electric', name: 'Diesel Electric Train', category: 'Mechanical', icon: 'train', file: 'Trains Diesel Electric.wav' },
  ],
  Crowd: [
    { id: 'arena_crowd', name: 'Arena Crowd', category: 'Crowd', icon: 'groups', file: 'Arena Crowd.wav' },
    { id: 'baby_crying', name: 'Baby Crying', category: 'Crowd', icon: 'child_care', file: 'Baby loud lament crying.wav' },
    { id: 'baseball_crowd', name: 'Baseball Crowd', category: 'Crowd', icon: 'sports_baseball', file: 'Baseball Crowd.wav' },
    { id: 'baseball_stadium', name: 'Baseball Stadium', category: 'Crowd', icon: 'stadium', file: 'Baseball Stadium Background.wav' },
    { id: 'basketball_crowd', name: 'Basketball Crowd', category: 'Crowd', icon: 'sports_basketball', file: 'Basketball Crowd.wav' },
    { id: 'kids_amusement', name: 'Amusement Park', category: 'Crowd', icon: 'attractions', file: 'Kids In Amusement Park.wav' },
    { id: 'village_playground', name: 'Village Playground', category: 'Crowd', icon: 'sports_gymnastics', file: 'Village And Playground.wav' },
    { id: 'prisoner_chains', name: 'Prisoner Chains', category: 'Crowd', icon: 'link', file: 'Prisoner in chains heavy footsteps.wav' },
  ]
};
